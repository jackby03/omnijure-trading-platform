...
namespace Omnijure.Visual.Input;
...
public class GlobalInputManager
{
    ...
    public void OnMouseDown(IMouse mouse, MouseButton button)
    {
        if (button == MouseButton.Left)
        {
            ...
            if (_layout.ChartRect.Contains(MousePos.X, MousePos.Y) && _chartTabs.ActiveTab.DrawingState.ActiveTool != Omnijure.Visual.Drawing.DrawingTool.None)
            {
