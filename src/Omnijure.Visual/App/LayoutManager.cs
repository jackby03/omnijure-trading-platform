...
public class LayoutManager
{
    ...
    public Omnijure.Visual.Shared.Lib.Drawing.DrawingTool? HandleToolbarClick(float x, float y)
    {
        ...
        if (toolbarRect.Contains(x, y))
        {
            ...
            var tools = new[]
            {
                Omnijure.Visual.Shared.Lib.Drawing.DrawingTool.None,
                Omnijure.Visual.Shared.Lib.Drawing.DrawingTool.TrendLine,
                Omnijure.Visual.Shared.Lib.Drawing.DrawingTool.HorizontalLine
            };
    ...
    public void Render(SKCanvas canvas, ChartRenderer chartRenderer, RingBuffer<Candle> buffer,
        ...
        RingBuffer<MarketTrade> trades, Omnijure.Visual.Shared.Lib.Drawing.DrawingToolState? drawingState,
        int screenWidth, int screenHeight, List<ScriptOutput>? scriptOutputs = null)
    {
        ...
        if (chartIsActiveCenter)
        {
            ...
            _leftToolbar.Render(canvas, chartArea.Height,
                drawingState?.ActiveTool ?? Omnijure.Visual.Shared.Lib.Drawing.DrawingTool.None,
    ...
    public void SetActiveScriptManager(Omnijure.Core.Features.Scripting.ScriptManager? scripts) => _panelContent.SetActiveScriptManager(scripts);
