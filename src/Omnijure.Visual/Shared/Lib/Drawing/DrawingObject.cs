...
public abstract class DrawingObject
{
    ...
    protected void DrawSelectionHandles(SKCanvas canvas, SKPoint[] points)
    {
        ...
        var handlePaint = PaintPool.Instance.Rent();
        var borderPaint = PaintPool.Instance.Rent();
        ...
        {
            PaintPool.Instance.Return(handlePaint);
            PaintPool.Instance.Return(borderPaint);
        }
    }
}
